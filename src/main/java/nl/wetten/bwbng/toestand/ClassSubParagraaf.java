...
/**
 * <p>Java class for class.sub-paragraaf complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="class.sub-paragraaf">
 *   &lt;complexContent>
...
@XmlType(name = "class.sub-paragraaf", propOrder = {
    "kop",
    "structuurtekst",
    "artikelOrSubParagraafOrLokaalStructuurWetgeving",
    "metaData"
})
@XmlSeeAlso({
    SubParagraaf.class
})
public class ClassSubParagraaf {
    ...
    protected List<Object> artikelOrSubParagraafOrLokaalStructuurWetgeving;
    ...
    /**
     * Gets the value of the artikelOrSubParagraafOrLokaalStructuurWetgeving property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the artikelOrSubParagraafOrLokaalStructuurWetgeving property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getArtikelOrSubParagraafOrLokaalStructuurWetgeving().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Object> getArtikelOrSubParagraafOrLokaalStructuurWetgeving() {
        if (artikelOrSubParagraafOrLokaalStructuurWetgeving == null) {
            artikelOrSubParagraafOrLokaalStructuurWetgeving = new ArrayList<Object>();
        }
        return this.artikelOrSubParagraafOrLokaalStructuurWetgeving;
    }
