 ...
 *       &lt;sequence>
 *         &lt;element ref="{}naam" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *       &lt;attGroup ref="{}attlist.naamlijst"/>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
...
@XmlRootElement(name = "naamlijst")
public class Naamlijst {

    @XmlElement(required = true)
    protected List<Naam> naam;
     ...
     * 
     */
    public List<Naam> getNaam() {
        if (naam == null) {
            naam = new ArrayList<Naam>();
        }
        return this.naam;
    }
